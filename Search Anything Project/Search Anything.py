...
def search(*args):
    ...
    def save_as(event=""):
        path = filedialog.asksaveasfilename(defaultextension=".txt", filetype=(("Text Document", "*.txt"), ("All Files", "*.*")))
    ...
    try:
        ...
        d = d.strftime("%I:%M %p")
        d = d[:-3] + c[16:19] + d[5:]
        time_date = d + "  " + c[:4] + "- " + c[8:10] + "/" + c[4:7] + "/" + c[20:] + " "
...
b1 = Button(root, text="Search", fg="#e6e8eb", bg="#2c4079", command=search)
